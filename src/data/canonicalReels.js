export const CANONICAL_REELS = [
  {
    ...
    captionEn: 'The Sharp V Yellow drop is here! 100% premium Egyptian cotton with a statement oversized fit for your workouts and street style 💛🔥 Available now exclusively via Drip Fit #DripFit #Streetwear',
    ...
    products: [
      {
        ...
        titleEn: 'The Sharp V Yellow Oversized T-Shirt',
        merchantId: '171842bd-daed-40ef-853f-917eab2ed437',
