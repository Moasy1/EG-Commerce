...
export const ROLE_NOTIFICATIONS = {
  buyer: [
    ...
    },
    {
      ...
      messageEn: 'Enjoy a special discount from Talieska Studio on all natural linen pieces.',
  ...
  creator: [
    ...
    },
    {
      ...
      messageEn: 'Talieska Studio approved your reel draft and activated your affiliate commission link.',
      timestamp: 'منذ يومين',
      timestampEn: '2 days ago',
      read: true,
      icon: 'task_alt',
